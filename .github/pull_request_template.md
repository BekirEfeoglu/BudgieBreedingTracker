...
- [ ] CI/workflow veya `.github/dependabot.yml` değiştiyse `CLAUDE.md`, `.claude/rules/ci-actions.md`, `obsidian-brain/infrastructure/ci-cd.md` ve bu şablon birlikte güncellendi
