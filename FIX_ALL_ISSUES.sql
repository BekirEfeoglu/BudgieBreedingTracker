...
-- 1. Fix birds table RLS policies
DO $$
BEGIN
...
-- 2. Fix user_notification_settings table - add missing columns
DO $$
BEGIN
    -- Add do_not_disturb_start column if it doesn't exist
    ...
    -- Add do_not_disturb_end column if it doesn't exist
    ...
    -- Add notification_sound column if it doesn't exist
    ...
    -- Add vibration column if it doesn't exist
...
-- 3. Check birds table structure and fix if needed
DO $$
BEGIN
...
-- 7. Verify all tables and policies
