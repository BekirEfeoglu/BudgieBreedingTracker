...
void main() {
  ...
  group('MendelianCalculator.calculateFromGenotypes', () {
    ...
    test(
      ...
      () {
        ...
        expect(results, isNotEmpty);
        final visual =
            results.where((r) => r.visualMutations.contains('ino')).toList();
  ...
  group('Slate Z-chromosome linkage', () {
    test(
      ...
      () {
        ...
        final parentalCompound = females.where(
          (r) =>
              r.phenotype.contains('Cinnamon') &&
              r.phenotype.contains('Slate'),
        );
        final recombinantSlate = females.where(
          (r) => r.phenotype == 'Slate',
        );
    ...
    test(
      'ino-slate linkage: tightest pair (~2 cM) yields linked results',
      () {
        final father = ParentGenotype(
          gender: BirdGender.male,
          mutations: {
    ...
    test(
      'slate visual mother x cinnamon carrier father: '
      ...
      () {
        ...
        final males = results
            ...
            .toList();
        expect(
          males.any((r) => r.visualMutations.contains('slate')),
          isTrue,
        );
    ...
    test(
      'slate+cinnamon in repulsion (split): '
    ...
    test(
      'slate carrier father x ino visual mother: '
      ...
      () {
        ...
        final males = results
            ...
            .toList();
        expect(
          males.any((r) => r.visualMutations.contains('ino')),
          isTrue,
        );
