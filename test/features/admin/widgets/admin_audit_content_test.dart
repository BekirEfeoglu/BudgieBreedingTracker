...
void main() {
  ...
  group('AuditContent', () {
    ...
    testWidgets('shows clear logs button when callback provided', (
      ...
      await tester.pump();
      expect(find.text('admin.clear_old_logs'), findsOneWidget);
    });
    ...
    testWidgets('hides clear logs button when callback is null', (
      ...
      await tester.pumpWidget(_wrap(AuditContent(logs: [_testLog])));
      await tester.pump();
      expect(find.text('admin.clear_old_logs'), findsNothing);
    });
    ...
    testWidgets('shows load more button when hasMore is true', (tester) async {
      ...
      await tester.pump();
      expect(find.text('admin.load_more'), findsOneWidget);
    });
    ...
    testWidgets('hides load more button when hasMore is false', (tester) async {
      ...
      await tester.pump();
      expect(find.text('admin.load_more'), findsNothing);
    });
    ...
    testWidgets('triggers onClearLogs callback on tap', (tester) async {
      ...
      await tester.pump();
      await tester.tap(find.text('admin.clear_old_logs'));
  ...
  group('AuditSummary', () {
    ...
    testWidgets('shows admin.total_entries label', (tester) async {
      ...
      await tester.pump();
      expect(find.text('admin.total_entries'), findsOneWidget);
    });
  });
