...
void main() {
  group('SettingsOverviewBanner', () {
    testWidgets('renders active count ratio', (tester) async {
      await tester.pumpWidget(
        _wrap(const SettingsOverviewBanner(activeCount: 7, totalCount: 10)),
      );
      await tester.pump();
    ...
    testWidgets('renders Card widget', (tester) async {
      await tester.pumpWidget(
        _wrap(const SettingsOverviewBanner(activeCount: 0, totalCount: 0)),
      );
      await tester.pump();
  ...
  group('ResetDefaultsButton', () {
    ...
    testWidgets('calls onPressed when tapped and not loading', (tester) async {
      bool pressed = false;
      await tester.pumpWidget(
        _wrap(ResetDefaultsButton(onPressed: () => pressed = true)),
      );
      await tester.pump();
