...
void main() {
  group('FeedbackDetailSheet', () {
    ...
    testWidgets('hides optional fields when absent', (tester) async {
      await pumpLocalizedApp(tester, _createSubject(item: _minimalItem));
      await tester.pumpAndSettle();
    ...
    testWidgets('shows priority segmented button', (tester) async {
      await pumpLocalizedApp(tester, _createSubject());
      await tester.pumpAndSettle();
      expect(find.text(l10n('admin.feedback_priority_low')), findsOneWidget);
      expect(find.text(l10n('admin.feedback_priority_normal')), findsOneWidget);
      expect(find.text(l10n('admin.feedback_priority_high')), findsOneWidget);
    });
