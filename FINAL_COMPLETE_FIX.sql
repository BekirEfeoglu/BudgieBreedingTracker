...
DO $$
BEGIN
    -- Add humidity_max column if it doesn't exist
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'user_notification_settings' AND column_name = 'humidity_max') THEN
        ALTER TABLE public.user_notification_settings ADD COLUMN humidity_max INTEGER DEFAULT 80;
    END IF;
    
    -- Add humidity_min column if it doesn't exist
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'user_notification_settings' AND column_name = 'humidity_min') THEN
        ALTER TABLE public.user_notification_settings ADD COLUMN humidity_min INTEGER DEFAULT 40;
    END IF;
    
    -- Add temperature_max column if it doesn't exist
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'user_notification_settings' AND column_name = 'temperature_max') THEN
        ALTER TABLE public.user_notification_settings ADD COLUMN temperature_max INTEGER DEFAULT 30;
    END IF;
    
    -- Add temperature_min column if it doesn't exist
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'user_notification_settings' AND column_name = 'temperature_min') THEN
        ALTER TABLE public.user_notification_settings ADD COLUMN temperature_min INTEGER DEFAULT 18;
    END IF;
    
    -- Add humidity_alerts_enabled column if it doesn't exist
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'user_notification_settings' AND column_name = 'humidity_alerts_enabled') THEN
        ALTER TABLE public.user_notification_settings ADD COLUMN humidity_alerts_enabled BOOLEAN DEFAULT TRUE;
    END IF;
    ...
    -- Add any other possible alert columns
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'user_notification_settings' AND column_name = 'temperature_alerts_enabled') THEN
        ALTER TABLE public.user_notification_settings ADD COLUMN temperature_alerts_enabled BOOLEAN DEFAULT TRUE;
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'user_notification_settings' AND column_name = 'light_alerts_enabled') THEN
        ALTER TABLE public.user_notification_settings ADD COLUMN light_alerts_enabled BOOLEAN DEFAULT TRUE;
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'user_notification_settings' AND column_name = 'noise_alerts_enabled') THEN
        ALTER TABLE public.user_notification_settings ADD COLUMN noise_alerts_enabled BOOLEAN DEFAULT TRUE;
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'user_notification_settings' AND column_name = 'motion_alerts_enabled') THEN
        ALTER TABLE public.user_notification_settings ADD COLUMN motion_alerts_enabled BOOLEAN DEFAULT TRUE;
    END IF;
END $$;
