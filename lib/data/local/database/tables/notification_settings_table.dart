...
class NotificationSettingsTable extends Table {
  ...
  BoolColumn get healthCheckEnabled =>
      boolean().withDefault(const Constant(true))();
  RealColumn get temperatureMin => real().withDefault(const Constant(37.0))();
  RealColumn get temperatureMax => real().withDefault(const Constant(38.0))();
  RealColumn get humidityMin => real().withDefault(const Constant(55.0))();
  RealColumn get humidityMax => real().withDefault(const Constant(65.0))();
  ...
  IntColumn get cleanupDaysOld => integer().withDefault(const Constant(30))();
