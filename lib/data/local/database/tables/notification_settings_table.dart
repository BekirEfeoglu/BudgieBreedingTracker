...
class NotificationSettingsTable extends Table {
  ...
  BoolColumn get bandingEnabled =>
      boolean().withDefault(const Constant(true))();
  RealColumn get temperatureMin => real().withDefault(const Constant(36.5))();
  RealColumn get temperatureMax => real().withDefault(const Constant(38.5))();
  RealColumn get humidityMin => real().withDefault(const Constant(50.0))();
  RealColumn get humidityMax => real().withDefault(const Constant(70.0))();
