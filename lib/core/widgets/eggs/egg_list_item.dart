...
class EggListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final statusColor = getEggStatusColor(status);

    return Semantics(
      label: '${'eggs.egg_label'.tr()} ${eggNumber ?? '?'}',
      child: Card(
              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Text(
                            '${'eggs.egg_label'.tr()} #${eggNumber ?? '?'}',
                            style: theme.textTheme.titleSmall,
                          ),
                          const SizedBox(width: AppSpacing.sm),
                          EggStatusChip(status: status),
                        ],
                      ),
                      const SizedBox(height: AppSpacing.xs),
                      Text(
                        '${'eggs.lay_label'.tr()}: ${dateFormat.format(layDate)}'
                        '  •  ${'eggs.days_count'.tr(namedArgs: {'count': '$incubationDays'})}',
                ...
                if (onStatusUpdate != null)
                  AppIconButton(
                    ...
                    semanticLabel: 'eggs.update_status'.tr(),
