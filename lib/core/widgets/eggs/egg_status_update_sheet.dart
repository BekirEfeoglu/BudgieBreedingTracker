...
Future<EggStatus?> showEggStatusUpdateSheet(
  ...
  required EggStatus currentStatus,
  required int? eggNumber,
  required List<EggStatus> transitions,
}) {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '${'eggs.egg_label'.tr()} #${eggNumber ?? '?'} - ${'eggs.update_status'.tr()}',
              ...
              Row(
                children: [
                  ...
                  EggStatusChip(status: currentStatus),
                ],
              ),
              const SizedBox(height: AppSpacing.lg),
