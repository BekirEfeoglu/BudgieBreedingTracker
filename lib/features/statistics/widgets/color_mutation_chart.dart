...
class ColorMutationChart extends StatelessWidget {
  ...
  static String _shortLabel(BirdColor color) => switch (color) {
        BirdColor.green => 'Yeşil',
        BirdColor.blue => 'Mavi',
        BirdColor.yellow => 'Sarı',
        BirdColor.white => 'Beyaz',
        BirdColor.grey => 'Gri',
        BirdColor.violet => 'Mor',
        BirdColor.lutino => 'Lut.',
        BirdColor.albino => 'Alb.',
        BirdColor.cinnamon => 'Tar.',
        BirdColor.opaline => 'Opal.',
        BirdColor.spangle => 'Span.',
        BirdColor.pied => 'Pied',
        BirdColor.clearwing => 'Cle.',
        BirdColor.other => 'Diğer',
        BirdColor.unknown => 'Diğer',
      };
}
