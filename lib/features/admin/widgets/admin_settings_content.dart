...
part 'admin_settings_content_cron.dart';
...
class _AdminSettingsContentState extends ConsumerState<AdminSettingsContent> {
  ...
  Widget _buildFeatureSection(List<String> keys) => AccentSettingsSection(
    ...
    children: [
      ...
      _toggle('community_enabled', 'community_feature', 'community_feature_desc'),
      _toggle('marketplace_enabled', 'marketplace_feature', 'marketplace_feature_desc'),
      _toggle('gamification_enabled', 'gamification_feature', 'gamification_feature_desc'),
      _toggle('messaging_enabled', 'messaging_feature', 'messaging_feature_desc'),
      _toggle('genetics_enabled', 'genetics_feature', 'genetics_feature_desc',
          showDivider: false),
    ],
  );
