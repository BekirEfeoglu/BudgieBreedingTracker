...
class _RolePermissionMatrixSection extends ConsumerWidget {
  const _RolePermissionMatrixSection();

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final theme = Theme.of(context);
    final matrix = ref.watch(adminRolePermissionMatrixProvider);
          ...
          children: [
            Row(
              children: [
                ...
                Text(
                  'admin.role_permission_matrix'.tr(),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: row.permissions
                          .map(
                            (permission) => Chip(
                              visualDensity: VisualDensity.compact,
                              label: Text('admin.permission_$permission'.tr()),
                            ),
                          )
                          .toList(),
                    ),
  ...
  Widget _buildResult(ThemeData theme) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          '${'admin.cron_scheduled_jobs'.tr()}: $jobs',
          style: theme.textTheme.bodySmall,
        ),
        Text(
          '${'admin.cron_total_snapshots'.tr()}: $snaps',
          style: theme.textTheme.bodySmall,
        ),
        if (latestAt != null)
          Text(
            '${'admin.cron_latest_snapshot'.tr()}: $latestAt',
            style: theme.textTheme.bodySmall,
          ),
        const SizedBox(height: AppSpacing.md),
        SizedBox(
