...
final syncStatusSummaryProvider = FutureProvider<SyncStatusSummary>((
  ref,
) async {
...
final softDeleteStatsProvider =
    FutureProvider.family<List<SoftDeleteStats>, int>((
      ref,
      olderThanDays,
    ) async {
      await requireAdmin(ref);
...
final orphanDataProvider = FutureProvider<OrphanDataSummary>((ref) async {
  ...
  try {
    ...
    final orphanHealthRecords = await client.rpc(
