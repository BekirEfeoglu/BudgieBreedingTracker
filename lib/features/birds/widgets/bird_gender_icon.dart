...
class BirdGenderIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return switch (gender) {
      BirdGender.male => AppIcon(AppIcons.male, size: size, color: AppColors.genderMale),
      BirdGender.female => AppIcon(AppIcons.female, size: size, color: AppColors.genderFemale),
      BirdGender.unknown => Icon(LucideIcons.helpCircle, size: size, color: AppColors.genderUnknown),
    };
  }
}
