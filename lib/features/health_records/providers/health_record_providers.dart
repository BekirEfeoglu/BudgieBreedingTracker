...
final healthRecordByIdProvider =
    StreamProvider.family<HealthRecord?, String>((ref, id) {
  final repo = ref.watch(healthRecordRepositoryProvider);
  return repo.watchById(id);
});

/// Count of non-deleted health records for a user (lightweight SQL COUNT).
final healthRecordCountProvider =
...
final searchedAndFilteredHealthRecordsProvider =
  ...
  final query = ref.watch(healthRecordSearchQueryProvider).toLowerCase().trim();
