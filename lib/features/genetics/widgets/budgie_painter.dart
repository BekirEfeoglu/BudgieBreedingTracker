...
class BudgiePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _paintZoneShaded(
      ...
      appearance.tailColor,
      Offset(w * 0.28, h * 0.76),
      w * 0.20,
    );
    ...
    if (h >= 56) {
      ...
      BudgieDetails.paintWingFeatherTexture(canvas, w, h, appearance.bodyColor);
      canvas.restore();
    }
    ...
    final isInoLike =
        appearance.eyeColor.r > 0.6 && appearance.eyeColor.g < 0.3;
    ...
    if (h >= 56) {
      ...
      BudgieDetails.paintBodyFeatherTexture(canvas, w, h, appearance.bodyColor);
      canvas.restore();
    }
    ...
    if (appearance.showPiedPatch) {
      ...
      if (appearance.isDutchPied) {
        _paintZoneShaded(
          canvas,
          BudgiePathsExtra.dutchPiedWingPatch(w, h),
          appearance.piedPatchColor,
  ...
  bool shouldRepaint(BudgiePainter oldDelegate) =>
      appearance != oldDelegate.appearance || isFemale != oldDelegate.isFemale;
}
