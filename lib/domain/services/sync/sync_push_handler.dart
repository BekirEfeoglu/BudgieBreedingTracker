...
class SyncPushHandler {
  ...
  Future<void> pushTable(String userId, String table) async {
    try {
      switch (table) {
        case SupabaseConstants.birdsTable:
          await _ref.read(birdRepositoryProvider).pushAll(userId);
        case SupabaseConstants.eggsTable:
          await _ref.read(eggRepositoryProvider).pushAll(userId);
        case SupabaseConstants.chicksTable:
          await _ref.read(chickRepositoryProvider).pushAll(userId);
        ...
        case SupabaseConstants.incubationsTable:
          await _ref.read(incubationRepositoryProvider).pushAll(userId);
        case SupabaseConstants.healthRecordsTable:
          await _ref.read(healthRecordRepositoryProvider).pushAll(userId);
        case SupabaseConstants.growthMeasurementsTable:
          await _ref.read(growthMeasurementRepositoryProvider).pushAll(userId);
        case SupabaseConstants.eventsTable:
          await _ref.read(eventRepositoryProvider).pushAll(userId);
        case SupabaseConstants.notificationsTable:
          await _ref.read(notificationRepositoryProvider).pushAll(userId);
        case SupabaseConstants.clutchesTable:
          await _ref.read(clutchRepositoryProvider).pushAll(userId);
        case SupabaseConstants.nestsTable:
          await _ref.read(nestRepositoryProvider).pushAll(userId);
        case SupabaseConstants.photosTable:
          await _ref.read(photoRepositoryProvider).pushAll(userId);
