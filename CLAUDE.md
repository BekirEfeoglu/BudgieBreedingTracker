...
python3 scripts/verify_rules.py          # CLAUDE.md stats vs codebase + 7 cross-surface guards (release artifacts, Edge fn names, bucket ids, l10n categories, icons, route targets, table names)
