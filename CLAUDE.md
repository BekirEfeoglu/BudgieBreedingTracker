...
| Test files (test/) | 902 test files, 11,074+ individual tests |
| Feature modules | 24 |
...
### Migrations
172 SQL migration files in `supabase/migrations/`. Schema managed server-side; never modify RLS policies from client code.
...
Migrations:    supabase/migrations/ (172 files)
Scripts:       scripts/
