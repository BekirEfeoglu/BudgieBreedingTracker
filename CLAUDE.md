...
| Metric | Value |
| --- | --- |
| Source files (lib/) | 981 Dart files |
| Test files (test/) | 900 test files, 11,036+ individual tests |
| Feature modules | 24 |
...
| L10n keys | ~2,983 per language, 41 categories |
...
### Migrations
159 SQL migration files in `supabase/migrations/`. Schema managed server-side; never modify RLS policies from client code.
...
Migrations:    supabase/migrations/ (159 files)
Scripts:       scripts/
