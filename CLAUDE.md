...
python3 scripts/verify_rules.py          # CLAUDE.md stats vs codebase + 6 cross-surface guards (release artifacts, Edge fn names, bucket ids, l10n categories, icon bijection, route targets)
