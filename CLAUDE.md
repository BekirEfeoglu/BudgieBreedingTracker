...
python3 scripts/verify_rules.py          # CLAUDE.md stats vs codebase + cross-surface guards (release artifacts, Edge fn names, buckets, l10n categories, icons, routes, tables/columns) — see documentation-sync.md table
