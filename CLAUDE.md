...
| Metric | Value |
| --- | --- |
| Source files (lib/) | 933 Dart files |
| Test files (test/) | 867 test files, 10,688+ individual tests |
| Feature modules | 24 |
...
### Migrations
152 SQL migration files in `supabase/migrations/`. Schema managed server-side; never modify RLS policies from client code.
...
Migrations:    supabase/migrations/ (152 files)
Scripts:       scripts/
