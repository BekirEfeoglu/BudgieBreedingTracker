...
| Test files (test/) | 949 test files, 11,698+ individual tests |
| Feature modules | 24 |
...
### Migrations
218 SQL migration files in `supabase/migrations/`. Schema managed server-side; never modify RLS policies from client code.
...
Migrations:    supabase/migrations/ (218 files)
Scripts:       scripts/
