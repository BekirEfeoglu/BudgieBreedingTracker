...
| Metric | Value |
| --- | --- |
| Source files (lib/) | 1001 Dart files |
| Test files (test/) | 912 test files, 11,321+ individual tests |
| Feature modules | 24 |
...
| L10n keys | ~3,021 per language, 41 categories |
...
### Migrations
183 SQL migration files in `supabase/migrations/`. Schema managed server-side; never modify RLS policies from client code.
...
Migrations:    supabase/migrations/ (183 files)
Scripts:       scripts/
