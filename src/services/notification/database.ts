...
export const loadUserSettings = async (): Promise<NotificationSettings | null> => {
  try {
    ...
    if (user) {
      ...
      // Eğer kayıt varsa ilkini kullan, yoksa varsayılan ayarları oluştur
      ...
      // Kayıt yoksa varsayılan ayarları oluştur ve kaydet
...
export const saveUserSettings = async (settings: NotificationSettings): Promise<void> => {
  try {
    ...
    const dbSettings: DatabaseNotificationSettings = {
