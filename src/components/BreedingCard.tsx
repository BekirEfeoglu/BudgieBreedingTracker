...
const BreedingCard = React.memo(({ 
  ...
  const { eggs: realTimeEggs, loading: eggsLoading, refetch: refetchEggs } = useEggData(breeding.id);
  ...
  }, [onDeleteEgg, breeding.id, refetchEggs, t]);
