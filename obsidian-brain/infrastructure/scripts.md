...
| `verify_rules.py` | CLAUDE.md stats vs codebase + cross-surface guards over 9 families (release artifacts, Edge fn names, buckets, l10n categories, icons, routes, tables/columns, gate parity, README metrics); the direction of each is tabulated in `documentation-sync.md` |
