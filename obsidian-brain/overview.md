...
| Test files | 927 files, 11,551+ individual tests |
| Feature modules | 24 |
...
| Shared widgets | 35 |
| Enum files | 15 |
| Supabase constants | 158 string constants |
| L10n keys | 3,140 per language, 41 categories |
| DB schema version | 27 |
| Supabase migrations | 208 tracked SQL files |
| Edge Functions | 12 |
