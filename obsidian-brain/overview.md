...
- ~3,214 keys per language, 41 categories
- See [[patterns/l10n]]
...
## Codebase Stats (verified 2026-07-29 via `verify_rules.py --strict`)

| Metric | Value |
|--------|-------|
| Source files (lib/) | 1037 Dart files |
| Test files | 958 files, 11,829+ individual tests |
| Feature modules | 24 |
...
| Supabase migrations | 226 tracked SQL files |
| Edge Functions | 12 |
