...
| [[log-archive-2026-07-m]] | Archived July 2026 change log entries (07-17 to 07-24 release, CI, and security hardening) |
...
| Page | Description |
|------|-------------|
| [[infrastructure/ci-cd]] | GitHub Actions jobs, release builds (`build_release.sh`), Xcode Cloud |
