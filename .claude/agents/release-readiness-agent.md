...
- **Codemagic** (production): `android-release` → Play alpha, `ios-release` → TestFlight (App ID 6759828211). Verify version bump before store submission.
