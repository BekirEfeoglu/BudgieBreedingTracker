...
-- Bu komutlar rate limiting'i tamamen devre dışı bırakır

-- 1. Tüm rate limiting değerlerini çok yüksek yap
UPDATE auth.config 
SET 
...
-- 2. E-posta doğrulamayı geçici olarak devre dışı bırak
UPDATE auth.config 
